...
urlpatterns = [
    ...
    path('api/promo/customersProducts/', views.get_promo_customers_products, name='Show Promo Client Products'),
    ...
    path('promo/customersProducts', views.update_promo_customers_products, name='Get Promo Client Products')
